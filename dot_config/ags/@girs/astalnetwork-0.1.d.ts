...
declare module 'gi://AstalNetwork?version=0.1' {
    ...
    export namespace AstalNetwork {
         ...
         * @param self
         */
        function primary_to_string(self: Primary | null): string;
        /**
         * @param type
         */
         ...
         * @param self
         */
        function state_to_string(self: State | null): string;
        /**
         * @param self
         */
        function connectivity_to_string(self: Connectivity | null): string;
        /**
         * @param self
         */
        function device_state_to_string(self: DeviceState | null): string;
        /**
         * @param device
         */
         ...
         * @param self
         */
        function internet_to_string(self: Internet | null): string;
